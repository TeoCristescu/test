...
-pagina de home (start.html)
-pagina de autentificare(Login2.html)
-pagina de creare a unui cont nou (ContNou2.html)
-pagina de editare a profilului(Detaliicont.html)
-pagina ce permite listarea de produse(ListareProduse.html)


Pagina de start(home) este start.html si contine:
-Bara de navigare cu urmatoarele functionalitati(bara am inclus-o de asemenea in fiecare pagina din website):
	-sectiunea Acasa (care va redirecta de oriunde ai fi in site inapoi in pagina de start)
	-sectiunea Despre
	-sectiunea Contact
	-sectiunea Contul meu : are 3 subsectiuni - autentificare(duce la pagina login2.html )			
						  -editare (duce la pagina pentru editarea informatiilor de profil detaliicont.html)
						  -cos
...
-Un startbox: alcatuit din -3 butoane (Masini,Moto,Piese)
			   -5 input-uri pt diferite informatii referitoare la ceea ce doriti sa cautati	
			   -un buton de cautare

Pagina ce permite listarea produselor (ListareProduse.html) contine:
-bara de navigare
-sigla
-3 select-uri folosite drept filtre
-12 poze in care listez produsele existe in categoria masini (poza + pretul masinii aferent)

 Pagina de autentificare(Login2.html) contine:
-bara de navigare
-sigla
...
Pagina de editare a profilului(Detalii cont.html) contine:
-bara de navigare
-sigla
...
Pagina de creare a unui cont nou(Contnou2.html) contine:
-bara de navigare
-sigla
